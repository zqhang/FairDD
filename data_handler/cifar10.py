...
class CIFAR_10S(VisionDataset):
    def __init__(self, root, split='train', transform=None, target_transform=None,
        ...
        imgs, labels, colors, data_count = self._make_skewed(root, split, seed, skewed_ratio, self.num_classes)
    ...
    def _make_skewed(self, data_path, split='train', seed=0, skewed_ratio=1., num_classes=10):
...
def CIFAR_10s(root, skew_ratio, seed = 0):
